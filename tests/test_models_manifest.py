...
class ModelsManifestTests(unittest.TestCase):
    ...
    def test_manifest_repairs_known_broken_links(self):
        ...
        expected_sources = {
            ...
            "dreamshaper-xl-v2-turbo": "Lykon/dreamshaper-xl-v2-turbo:DreamShaperXL_Turbo_v2_1.safetensors",
            "juggernaut-xl-lightning": "RunDiffusion/Juggernaut-XL-Lightning:Juggernaut_RunDiffusionPhoto2_Lightning_4Steps.safetensors",
            "juggernaut-xl-v9": "RunDiffusion/Juggernaut-XL-v9:Juggernaut-XL_v9_RunDiffusionPhoto_v2.safetensors",
            "cyberrealistic-xl-v10": "cyberdelia/CyberRealisticXL:CyberRealisticXLPlay_V10.0_FP16.safetensors",
