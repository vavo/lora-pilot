...
- Tagged releases publish the large runtime bundles to Cloudflare R2, keep the manifest and checksum files on the GitHub release, and wait for those public runtime URLs before publishing the installer.
