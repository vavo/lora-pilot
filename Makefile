...
AI_TOOLKIT_REF ?= 27a03a91f23eb1b757d5ec2e80ee3e129cfcc350
...
DOCKER_BUILD_ARGS = \
	...
	--build-arg DEEPDIFF_VERSION="$(DEEPDIFF_VERSION)" \
	--build-arg GGUF_VERSION="$(GGUF_VERSION)" \
	--build-arg TOMLKIT_VERSION="$(TOMLKIT_VERSION)" \
	...
	--build-arg HF_TRANSFER_VERSION="$(HF_TRANSFER_VERSION)" \
